        ...
        if($search_target && $search_keyword) {
            switch($search_target) {
                ...
                case 'regdate_less' :
                    ...
                    break;
                case 'readed_date' :
                        $args->s_readed_date = preg_replace("/[^0-9]/","",$search_keyword);
                    break;
                case 'readed_date_more' :
                        $args->s_readed_date_more = substr(preg_replace("/[^0-9]/","",$search_keyword) . '00000000000000',0,14);
                    break;
                case 'readed_date_less' :
                        $args->s_readed_date_less = substr(preg_replace("/[^0-9]/","",$search_keyword) . '00000000000000',0,14);
                    break;
            }
        }
